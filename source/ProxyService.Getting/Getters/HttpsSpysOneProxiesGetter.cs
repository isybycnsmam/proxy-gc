...
public sealed class HttpsSpysOneProxiesGetter(
    IHttpClientFactory httpClientFactory,
    ILogger<HttpsSpysOneProxiesGetter> logger) : IProxiesGetter
{
    public string Name => "HttpsSpysOne";
    private readonly IHttpClientFactory _httpClientFactory = httpClientFactory;
    private readonly ILogger<HttpsSpysOneProxiesGetter> _logger = logger;
    ...
    public async Task<List<Proxy>> GetProxiesAsync(CancellationToken cancellationToken)
    {
        ...
        response = FckKeyDecryptor.DecryptPortNumbers(response);
    ...
    private static ProxyAnonymity ConvertStringToAnonymity(string source)
    {
        ...
        {
            "ANM" => ProxyAnonymity.Anonymous,
            "HIA" => ProxyAnonymity.HighAnonymous,
