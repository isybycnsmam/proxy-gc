...
{
    public class ProxyOrgProxiesGetter : IProxiesGetter
    {
        ...
        public readonly ILogger<ProxyOrgProxiesGetter> _logger;
        private static readonly List<string> _subSites = new() {
        ...
        public ProxyOrgProxiesGetter(
            IHttpClientFactory httpClientFactory,
            ILogger<ProxyOrgProxiesGetter> logger)
        {
